...
export default function CallToAction() {
  return (
    <section className="py-20 bg-gradient-to-r from-primary-600 via-primary-700 to-accent-600 text-white relative overflow-hidden">
      ...
      <Container className="relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              variant="primary" 
              className="bg-white text-primary-600 hover:bg-gray-100 font-semibold px-8 py-4 text-lg"
            >
              Sobre Nosotros
            </Button>
            <Button 
      ...
      <div className="absolute bottom-10 right-10 w-32 h-32 bg-accent-400/20 rounded-full blur-2xl"></div>
